...
class FoodSpecialistAgent:
    ...
    def _create_food_tools(self) -> List[FunctionTool]:
        ...
        def get_menu_items(category: str = None, dietary_restrictions: List[str] = None) -> Dict[str, Any]:
            """
        ...
        def get_dish_details(dish_name: str) -> Dict[str, Any]:
            ...
            return {"found": False, "suggestions": self._suggest_similar_dishes(dish_name)}
        ...
        def check_allergens(allergens_to_avoid: List[str]) -> Dict[str, Any]:
            ...
            for category, items in self.menu_data.items():
                for item in items:
                    ...
                    has_allergen = any(allergen in item_allergens for allergen in allergens_to_avoid)
        ...
        return [
            FunctionTool.create(self.__class__, "get_menu_items"),
            FunctionTool.create(self.__class__, "get_dish_details"),
            FunctionTool.create(self.__class__, "check_allergens"),
            FunctionTool.create(self.__class__, "get_ingredient_info"),
            FunctionTool.create(self.__class__, "recommend_dishes")
        ]
...
""",
    ...
    def _get_preparation_info(self, dish_name: str) -> str:
        ...
        return preparation_methods.get(dish_name.lower(), "Preparado con técnicas tradicionales y ingredientes frescos de primera calidad.")
    ...
    def _get_allergen_details(self, allergens: List[str]) -> Dict[str, str]:
        ...
        return {allergen: allergen_info.get(allergen, f"Contiene {allergen}") for allergen in allergens}
    ...
    def _get_ingredient_details(self, ingredient: str) -> str:
        ...
        return ingredient_details.get(ingredient.lower(), f"Ingrediente de primera calidad: {ingredient}")
